...
import hr.algebra.model.repositories.interfaces.HealthFunctionRepository;
import hr.algebra.model.repositories.interfaces.OperatingSystemRepository;
import hr.algebra.model.repositories.interfaces.SmartWatchHealthFunctionRepository;
import hr.algebra.model.repositories.interfaces.SmartWatchRepository;
...
public class SmartWatchRepositoryImpl extends RepositoryImpl<SmartWatch> implements SmartWatchRepository {
    ...
    private SmartWatch mapFull(ResultSet rs) throws SQLException{
    ...
    private void enrich(SmartWatch watch) throws Exception {
        ...
        watch.setSmartWatchOperatingSystem(
    ...
    public void deleteById(int id) throws SQLException{
        ...
        deleteSmartWatchHealthFunctions(id);
        deleteSmartWatchOperatingSystem(id);
    ...
    public void deleteSmartWatchHealthFunctions(int smartWatchId) throws SQLException{
        String sql = "DELETE FROM [SmartWatchHealthFunction] WHERE smart_watch_id = ?";
        try(PreparedStatement ps = this.connection.prepareStatement(sql)){
            ps.setInt(1, smartWatchId);
            ps.executeUpdate();
        }
    ...
    public void deleteSmartWatchOperatingSystem(int smartWatchId) throws SQLException{
        String sql = "DELETE FROM [SmartWatchOperatingSystem] WHERE smart_watch_id = ?";
        try(PreparedStatement ps = this.connection.prepareStatement(sql)){
            ps.setInt(1, smartWatchId);
            ps.executeUpdate();
        }
